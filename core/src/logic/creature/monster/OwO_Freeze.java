...
public class OwO_Freeze extends OwO {
	...
	public OwO_Freeze(String name, double positionX, double positionY) {
		super("Freeze-" + name, 2, positionX, positionY, new Texture("Monsters/Freeze OwO/new_owo_freeze.png"), new Texture("Monsters/Freeze OwO/new_owo_freeze_attack.png"), new Texture("Monsters/Freeze OwO/new_owo_freeze_jump.png"));
	}
