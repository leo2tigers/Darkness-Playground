...
public class OwO_Ranger extends OwO {
	...
	public OwO_Ranger(GameMap map, String name, double positionX, double positionY) {
		super(map, "Ranger-" + name, 2, positionX, positionY, new Texture("Monsters/Ranged OwO/new_ranged_owo.png"),
	...
	protected void attackMethod() {
		...
		map.add(new Projectile(positionX, positionY + this.hitBox.getWidth() / 3, /* width */20, /* height */20,
				orientation, /* speed */5, /* lifetime */1000, damage, Projectile.TO_PLAYER,
	...
	public static Spawnable spawnable = new Spawnable() {
		...
		public Monster spawn(SpawnPoint spawnPoint) {
			return new OwO_Ranger(spawnPoint.getMap(), "",
