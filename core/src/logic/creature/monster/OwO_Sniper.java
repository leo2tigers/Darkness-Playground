...
public class OwO_Sniper extends OwO {
	...
	public OwO_Sniper(GameMap map, String name, double positionX, double positionY) {
		super(map, "Sniper-" + name, 5, positionX, positionY, new Texture("Monsters/Sniper OwO/new_sniper_owo.png"),
	...
	protected void attackMethod() {
		...
		if (this.orientation == -1) {
			map.add(new Projectile(positionX, positionY + this.hitBox.getHeight() / 3, /* width */75, /* height */25,
					orientation, /* speed */12, /* lifetime */5000, damage, Projectile.TO_PLAYER,
			...
			map.add(new Projectile(positionX + this.img.getWidth(), positionY + this.hitBox.getHeight() / 3,
					/* width */75, /* height */25, orientation, /* speed */12, /* lifetime */5000, damage,
					Projectile.TO_PLAYER, "Monsters/Sniper OwO/sniper_projectile_right.png",
	...
	public static Spawnable spawnable = new Spawnable() {
		...
		public Monster spawn(SpawnPoint spawnPoint) {
			return new OwO_Sniper(spawnPoint.getMap(), "",
					Meth.center_random(spawnPoint.getX(), spawnPoint.getSpawnWidth()), spawnPoint.getY());
		}
	};
}
