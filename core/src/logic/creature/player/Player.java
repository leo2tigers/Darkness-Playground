...
public class Player extends Creature {
	...
	public Player(GameMap map, String name, double positionX, double positionY, Gun gun, MainGame screen) {
		...
		this.setHitBox(PlayerStats.HitBox.RELATIVE_X, PlayerStats.HitBox.RELATIVE_Y, PlayerStats.HitBox.WIDTH,
				PlayerStats.HitBox.HEIGHT);
		...
		this.playerAnimation[0][0] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_stand_still_left.png"));
		this.playerAnimation[0][1] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_run1_left.png"));
		this.playerAnimation[0][2] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_run2_left.png"));
		this.playerAnimation[0][3] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_run3_left.png"));
		this.playerAnimation[0][4] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_run4_left.png"));
		this.playerAnimation[0][5] = new Animation<Texture>(0.3f,
				new Texture("Player/Pistol/player_w-pistol_fire_left.png"));
		this.playerAnimation[0][6] = new Animation<Texture>(0.3f,
				new Texture("Player/Pistol/player_w-pistol_after_fire_left.png"));
		this.playerAnimation[1][0] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_stand_still_right.png"));
		this.playerAnimation[1][1] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_run1_right.png"));
		this.playerAnimation[1][2] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_run2_right.png"));
		this.playerAnimation[1][3] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_run3_right.png"));
		this.playerAnimation[1][4] = new Animation<Texture>(0.2f,
				new Texture("Player/Pistol/player_w-pistol_run4_right.png"));
		this.playerAnimation[1][5] = new Animation<Texture>(0.3f,
				new Texture("Player/Pistol/player_w-pistol_fire_right.png"));
		this.playerAnimation[1][6] = new Animation<Texture>(0.3f,
				new Texture("Player/Pistol/player_w-pistol_after_fire_right.png"));
		this.timeRunning = 0;
	...
	public void setAnimationState(int animationState) {
		...
		if (this.animationState == 0) {
			this.setHitBox(PlayerStats.HitBox.RELATIVE_X, PlayerStats.HitBox.RELATIVE_Y, PlayerStats.HitBox.WIDTH / 2,
					PlayerStats.HitBox.HEIGHT);
			this.setMovementBox(PlayerStats.MovementBox.RELATIVE_X, PlayerStats.MovementBox.RELATIVE_Y,
	...
	public String toString() {
		return super.toString() + " , " + (gun != null ? gun : "unarmed") + " , XP = " + this.xp + " / "
				+ this.xpToNextLevel;
	}
	...
	public void render(SpriteBatch batch) {
		...
		try {
			batch.draw(this.playerAnimation[orientation][this.animationState].getKeyFrame(stateTime, true),
