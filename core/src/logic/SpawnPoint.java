...
public class SpawnPoint extends GameObject {
	...
	public void spawn() {
		for (int i = 0; i < (int) ((lastSpawnDate.getTime() - startSpawnDate.getTime()) / this.spawnDelay
				* this.spawnRate); i++) {
	...
	public void shapeRender(ShapeRenderer shapeRenderer) {
		shapeRenderer.rect((float) positionX, (float) positionY, 50, 50, Color.PINK, Color.PINK, Color.PINK,
				Color.PINK);
	}
	...
	public String toString() {
		return "SpawnPoint<" + monsterType.TypeName + "> delay = " + spawnDelay + " ms SpawnCount = " + spawnCount
